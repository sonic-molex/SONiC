...
- [SONiC-OCS HLD](#sonic-ocs-hld)
    ...
    - [7 High-Level/Module Design](#7-high-levelmodule-design)
      ...
      - [7.3.2 State DB and PM counter update](#732-state-db-and-pm-counter-update)
        - [7.3.2 Device specific lua script example](#732-device-specific-lua-script-example)
...
##### 7.3.2 Device specific lua script example
...
An OCS device may not fit either of the above architecture. 

<img src="./images/ocs-port-db.png" alt="Redis script" width="600">
